...
bc_ids = pd.read_excel(
    "/Users/nadimtellezbarrera/Library/CloudStorage/OneDrive-EVI/11-LSO/Go Live Simulation/3. Items/Upload - Final Map/LSO_ItemsToCreate_SimpleMap_NaTe_11.18.2022_V4.xlsx")
print(bc_ids)
...
def captureDataFromApi():
    ...
    df.to_csv("/Users/nadimtellezbarrera/Library/CloudStorage/OneDrive-EVI/11-LSO/Go Live Simulation/3. Items/Complete Master/items.csv", index=False)
    df.to_csv("/Users/nadimtellezbarrera/Library/CloudStorage/OneDrive-EVI/11-LSO/Go Live Simulation/3. Items/Complete Master/items_" +
...
def readItemsTransform():
    ...
    df_final.to_csv(
        "/Users/nadimtellezbarrera/Library/CloudStorage/OneDrive-EVI/11-LSO/Go Live Simulation/3. Items/Download Odoo/items.csv", index=False)
    df_final.to_csv("/Users/nadimtellezbarrera/Library/CloudStorage/OneDrive-EVI/11-LSO/Go Live Simulation/3. Items/Download Odoo/items" +
                    date_time.strftime("%m%d%y_%H%M%S") + ".csv.gz", index=False, compression='gzip')
    df_final.to_excel(
        "/Users/nadimtellezbarrera/Library/CloudStorage/OneDrive-EVI/11-LSO/Go Live Simulation/3. Items/Download Odoo/items.xlsx", index=False)
