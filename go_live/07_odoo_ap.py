...
def rewrite_ar_report(file_name):
    df = pd.read_excel(
        "/Users/nadimtellezbarrera/Library/CloudStorage/OneDrive-EVI/11-LSO/Go Live Simulation/9. Open AP/Download Odoo/" + file_name)
    ...
    df_final.to_csv("/Users/nadimtellezbarrera/Library/CloudStorage/OneDrive-EVI/11-LSO/Go Live Simulation/9. Open AP/Download Odoo/aged_payable_transformed_" +
...
def readApAndTransform():
    ...
    df_ap.to_csv("/Users/nadimtellezbarrera/Library/CloudStorage/OneDrive-EVI/11-LSO/Go Live Simulation/9. Open AP/Download Odoo/open_ap_output_" +
                 date_time.strftime("%m%d%y") + ".csv", index=False)
    df_ap.to_excel("/Users/nadimtellezbarrera/Library/CloudStorage/OneDrive-EVI/11-LSO/Go Live Simulation/9. Open AP/Download Odoo/open_ap_output_" +
                   date_time.strftime("%m%d%y") + ".xlsx", index=False)


# captureDataFromApi(1000,"account.move")
# rewrite_ar_report("aged_payable-Odoo-09-16-2022-0142am.xlsx")
# rewrite_ar_report("OPENAP-LSO-11-17-2022.xlsx")
# rewrite_ar_report("OPENAP-LSO-11-18-2022.xlsx")
readApAndTransform()
